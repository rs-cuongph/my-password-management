...
const HomePage: React.FC = () => {
  ...
  const techStack = [
    ...
    { name: 'Tanstack Query', icon: '🔍', color: 'from-green-500 to-teal-500' },
    { name: 'Tanstack Router', icon: '🛣️', color: 'from-orange-500 to-red-500' },
    { name: 'Zustand', icon: '🐻', color: 'from-amber-500 to-orange-500' },
    { name: 'Valibot', icon: '✅', color: 'from-emerald-500 to-green-500' },
          ...
          <div className="max-w-4xl mx-auto text-center">
            <div className="animate-fade-in">
              ...
              <p className="text-xl text-neutral-600 dark:text-neutral-400 mb-8 max-w-2xl mx-auto">
                Ứng dụng quản lý mật khẩu hiện đại với bảo mật end-to-end và giao diện thân thiện
              </p>
            </div>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-neutral-600 dark:text-neutral-400">
              Được xây dựng với các công nghệ tiên tiến nhất
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {techStack.map((tech, index) => (
              ...
              >
                <div className={`w-12 h-12 mx-auto mb-4 bg-gradient-to-r ${tech.color} rounded-xl flex items-center justify-center text-2xl`}>
                  {tech.icon}
                </div>
      ...
      <div className="bg-neutral-100 dark:bg-neutral-900 px-4 py-16 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-neutral-600 dark:text-neutral-400">
              Bảo mật cao với trải nghiệm người dùng tuyệt vời
            </p>
          </div>
            ...
            {[
              {
                ...
                description: 'Mã hóa AES-256 với Argon2 để bảo vệ dữ liệu của bạn',
              ...
              },
              {
                ...
                title: 'Dark Mode',
                description: 'Giao diện tối hiện đại, dễ dàng cho mắt trong mọi điều kiện',
              ...
              },
              {
                ...
                title: 'Hiệu năng cao',
                description: 'Tối ưu hóa với React 19 và Vite cho tốc độ nhanh chóng',
              ...
              },
              {
                ...
                title: 'Auto-lock',
                description: 'Tự động khóa ứng dụng để bảo vệ dữ liệu khi không sử dụng',
              ...
              },
              {
                ...
                description: 'Tự động xóa clipboard sau khi copy để tăng cường bảo mật',
              ...
              <div
                ...
                style={{ animationDelay: `${index * 0.1}s` }}
              >
                <div className={`w-16 h-16 mx-auto mb-6 bg-gradient-to-r ${feature.color} rounded-2xl flex items-center justify-center text-white transform group-hover:scale-110 transition-transform duration-200`}>
                  {feature.icon}
                </div>

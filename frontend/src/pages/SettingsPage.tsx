          ...
          component: (
            <div className="flex items-center gap-3">
              <span className="text-sm text-neutral-600 dark:text-neutral-400">
                {theme === 'system' ? `Hệ thống (${resolvedTheme})` : theme === 'light' ? 'Sáng' : 'Tối'}
              </span>
  ...
  return (
    <div className="min-h-screen">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-16">
            <div className="flex items-center gap-6">
              ...
              <span className="text-neutral-700 dark:text-neutral-300 font-medium">Cài đặt</span>
            </div>
      ...
      <div className="max-w-4xl mx-auto px-4 py-8 sm:px-6 lg:px-8">
        ...
        {/* Action Buttons */}
        <div className="mt-12 pt-8 border-t border-neutral-200 dark:border-neutral-800 animate-slide-up" style={{ animationDelay: '0.5s' }}>
            ...
            <div className="card p-6 bg-white border-2 border-neutral-200">
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">Giao diện sáng, phù hợp ban ngày</p>
                </div>
              </div>
            ...
            <div className="card p-6 bg-neutral-900 border-2 border-neutral-700">
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-neutral-400">Giao diện tối, dễ chịu cho mắt</p>
                </div>
              </div>
              <div className="space-y-2">

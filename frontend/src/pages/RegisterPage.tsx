...
import { RegisterWithConfirmSchema, type RegisterInput } from '../schemas/auth';
...
const RegisterPage: React.FC = () => {
  ...
  const getPasswordStrength = (password: string) => {
    ...
    if (strength < 4) return { label: 'Trung bình', color: 'warning', width: '60%' };
      ...
      <div className="relative max-w-md w-full mx-4">
              ...
              {formData.password && (
                <div className="mt-2">
                  <div className="flex items-center justify-between mb-1">
                    <span className="text-xs text-neutral-600 dark:text-neutral-400">Độ mạnh mật khẩu</span>
        ...
        <div className="mt-8 text-center">
          <p className="text-xs text-neutral-500 dark:text-neutral-400">
            ...
            <Link to="/" className="ml-1 text-primary-600 dark:text-primary-400 hover:underline">
              Tìm hiểu thêm
            </Link>
          </p>
        </div>

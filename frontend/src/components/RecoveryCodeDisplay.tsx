...
---
Generated by Vibe Kanban - Secure Password Manager
`;
        ...
        <div className="p-6">
            ...
            <div className="flex">
              ...
              <div className="ml-3">
                ...
                <div className="mt-2 text-sm text-red-700">
                  <p>This recovery code can access your vault without your master password. Store it securely!</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-gray-50 rounded-lg p-6 mb-6">
            ...
            <p className="text-xs text-gray-500 mt-2">
              Generated: {new Date(recoveryCode.createdAt).toLocaleString()} | Version: {recoveryCode.version}
            </p>
          </div>

          {/* Instructions */}
          <div className="mb-6">
            <h3 className="text-lg font-medium text-gray-900 mb-3">📋 Important Instructions</h3>
          ...
          <div className="bg-blue-50 rounded-lg p-4 mb-6">
            <h4 className="text-md font-medium text-blue-900 mb-3">💾 Secure Storage Options</h4>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
              ...
              <div className="flex items-center space-x-2">
                ...
                <span className="text-blue-800">Password manager (separate)</span>
              </div>
              <div className="flex items-center space-x-2">
                <svg className="w-5 h-5 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="mb-6">
            <label className="flex items-start space-x-3">
              ...
              <span className="text-sm text-gray-700">
                I understand that I need to store this recovery code securely and that it can be used to access my vault without my master password. I acknowledge that losing this code may make vault recovery impossible if I forget my master password.
              </span>
            </label>
          </div>
          ...
          <div className="mt-4 text-xs text-gray-500 text-center">
            ⚠️ This dialog will not be shown again. Make sure you have securely stored your recovery code before closing.
          </div>
        </div>
      </div>
    </div>

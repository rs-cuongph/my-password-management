...
export const VaultDashboard: React.FC<VaultDashboardProps> = ({
  ...
  return (
    <div className="container mx-auto px-4 py-6 max-w-7xl">
      ...
      <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6 mb-8">
        <div className="animate-slide-up">
          ...
          <p className="text-neutral-600 dark:text-neutral-400 mt-2 flex items-center gap-2">
            ...
            <span className="font-medium text-primary-600 dark:text-primary-400">{entries.length}</span>
      ...
      {/* Search và Controls */}
      <div className="card p-6 mb-8 animate-slide-up" style={{ animationDelay: '0.2s' }}>
      ...
      {searchTerm && (
        <div className="mb-6 animate-fade-in">
          <p className="text-sm text-neutral-600 dark:text-neutral-400">
            Tìm thấy <span className="font-medium text-primary-600 dark:text-primary-400">{filteredAndSortedEntries.length}</span> kết quả cho 
            ...
            >
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-between gap-3">
                  <div className="flex items-center gap-3 min-w-0 flex-1">
                    <span className="text-sm text-neutral-500 dark:text-neutral-400 w-20 flex-shrink-0">Tài khoản</span>
                ...
                <div className="flex items-center justify-between gap-3">
                  <div className="flex items-center gap-3 min-w-0 flex-1">
                    <span className="text-sm text-neutral-500 dark:text-neutral-400 w-20 flex-shrink-0">Mật khẩu</span>
                  ...
                  <div className="space-y-2 pt-2 border-t border-neutral-200 dark:border-neutral-800">
                    {entry.hint && (
                      <div className="flex items-start gap-3">
                        <span className="text-sm text-neutral-500 dark:text-neutral-400 w-20 flex-shrink-0">Gợi ý</span>
                        <span className="text-sm text-neutral-700 dark:text-neutral-300">{entry.hint}</span>
                      </div>
                    )}
                    {entry.notes && (
                      <div className="flex items-start gap-3">
                        <span className="text-sm text-neutral-500 dark:text-neutral-400 w-20 flex-shrink-0">Ghi chú</span>
                        <span className="text-sm text-neutral-700 dark:text-neutral-300">{entry.notes}</span>
                      </div>
                    )}
                  </div>
                )}
                ...
                {entry.tags && entry.tags.length > 0 && (
                  <div className="flex items-center gap-3 pt-2">
                    <span className="text-sm text-neutral-500 dark:text-neutral-400 w-20 flex-shrink-0">Tags</span>

...
interface AutoLockTimeoutSettingsProps {
  className?: string;
}

const AUTO_LOCK_OPTIONS = [
  { value: 1 * 60 * 1000, label: '1 phút' },
  { value: 2 * 60 * 1000, label: '2 phút' },
  { value: 5 * 60 * 1000, label: '5 phút' },
  { value: 10 * 60 * 1000, label: '10 phút' },
  { value: 15 * 60 * 1000, label: '15 phút' },
  { value: 30 * 60 * 1000, label: '30 phút' },

...
export const VaultExportImport: React.FC<VaultExportImportProps> = ({ className }) => {
    ...
    <div className={`space-y-4 ${className}`}>
      ...
      <div className="card p-4 bg-warning-50 dark:bg-warning-900/20 border border-warning-200 dark:border-warning-800">
        <div className="flex items-start gap-3">
          <svg className="w-5 h-5 text-warning-600 dark:text-warning-400 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div>
            ...
            <p className="text-xs text-warning-600 dark:text-warning-400 mt-1">
              • Dữ liệu xuất ra vẫn được mã hóa, cần master password để mở<br/>
              • Nhập vault sẽ thay thế toàn bộ dữ liệu hiện tại<br/>
              • Nên tạo bản sao lưu trước khi nhập dữ liệu mới
            </p>
          </div>
        </div>
      </div>
